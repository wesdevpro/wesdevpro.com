   ...
   <section class="section has-text-left">
      ...
      <div class="media box" style="z-index: 1">
         ...
         <p class="media-content" style="text-indent: 1em">
            ...
            posts, articles, and career. I hope all the resources that I have
            here are helpful to you. All your feedback is appreciated. Thank
            you, and God bless. <br />
            <i style="margin-left: 20px">~Wesley Ford</i>
         </p>
      </div>
   </section>
</template>
